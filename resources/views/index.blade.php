        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>PENDUDUK</h3>
                </a>
                <div class="d-flex align-items-center ms-4 mb-4">
                    <a href="{{ route('keluargakk.index') }}"
                        class="nav-item nav-link {{ request()->routeIs('keluargakk.*') ? 'active' : '' }}">
                        <i class="fa fa-users me-2"></i>Keluarga KK
                    </a>
                </div>
            </nav>
        </div>
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="asset admin/mg/user.jpg" alt=""
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">KEPENDUDUKAN</a>, All Right Reserved.
                        </div>
                    </div>
                </div>
            </div>
