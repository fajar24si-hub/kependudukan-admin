                        ...
                        <div class="card border mb-4">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    @if ($user->foto_profil && Storage::disk('public')->exists($user->foto_profil))
                                        ...
                                        <div class="file-info mb-3">
                                            ...
                                            <small class="text-info d-block">
                                                ...
                                                Diupload: {{ \Carbon\Carbon::parse($user->foto_profil_updated_at ?? $user->updated_at)->format('d/m/Y') }}
                                            </small>
                                        </div>
                                    @else
                                        <div class="mb-3">
                                    ...
                                    @if ($user->foto_profil && Storage::disk('public')->exists($user->foto_profil))
                                        <div class="mt-3">
                                            <a href="{{ Storage::url($user->foto_profil) }}" target="_blank"
                                                class="btn btn-sm btn-outline-primary">
                                                <i class="fas fa-eye me-1"></i> Lihat Full
                                            </a>
                                            <a href="{{ Storage::url($user->foto_profil) }}" download
