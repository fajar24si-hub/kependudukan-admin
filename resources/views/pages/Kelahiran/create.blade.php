    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('peristiwa-kelahiran.store') }}" method="POST" enctype="multipart/form-data"
                        id="kelahiranForm">
                        @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="ayah_warga_id"
                                        class="form-control @error('ayah_warga_id') is-invalid @enderror" required>
                                        <option value="">Pilih Ayah</option>
                                        @foreach ($wargas as $warga)
                                            <option value="{{ $warga->warga_id }}"
                                                {{ old('ayah_warga_id') == $warga->warga_id ? 'selected' : '' }}>
                                                {{ $warga->nama }} - {{ $warga->nik }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="ibu_warga_id"
                                        class="form-control @error('ibu_warga_id') is-invalid @enderror" required>
                                        <option value="">Pilih Ibu</option>
                                        @foreach ($wargas as $warga)
                                            <option value="{{ $warga->warga_id }}"
                                                {{ old('ibu_warga_id') == $warga->warga_id ? 'selected' : '' }}>
                                                {{ $warga->nama }} - {{ $warga->nik }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" name="files[]"
                                                ...
                                                multiple onchange="previewFiles(this)">
                                            @error('files.*')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
