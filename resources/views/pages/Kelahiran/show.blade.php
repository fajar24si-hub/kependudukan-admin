        ...
        <div class="card">
            ...
            <div class="card-body">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="card border h-100">
                                                <div class="card-body text-center">
                                                    ...
                                                    @else
                                                        <a href="{{ Storage::url('public/media/' . $media->file_name) }}"
                                                           target="_blank" class="d-block mb-2 text-decoration-none">
                                                            <div class="py-3">
                ...
                <div class="d-flex gap-2 mt-4 pt-3 border-top">
                    <a href="{{ route('peristiwa-kelahiran.edit', $kelahiran->kelahiran_id) }}" class="btn btn-warning">
                        <i class="fas fa-edit me-1"></i> Edit Data
                    </a>
                    <form action="{{ route('peristiwa-kelahiran.destroy', $kelahiran->kelahiran_id) }}" method="POST" class="d-inline"
