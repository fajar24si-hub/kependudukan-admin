    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('peristiwa-kelahiran.update', $kelahiran->kelahiran_id) }}" method="POST"
                        enctype="multipart/form-data" id="kelahiranForm">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="card border mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="no_akta"
                                                    ...
                                                    placeholder="Masukkan nomor akta" required minlength="3"
                                                    maxlength="100">
                                                @error('no_akta')
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                <label class="form-label">
                                                    Data Bayi (Warga) <span class="text-danger">*</span>
                                                </label>
                                                <select name="warga_id"
                                                    ...
                                                    @foreach ($wargas as $warga)
                                                        <option value="{{ $warga->warga_id }}"
                                                            {{ old('warga_id', $kelahiran->warga_id) == $warga->warga_id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select name="ayah_warga_id"
                                                    class="form-control @error('ayah_warga_id') is-invalid @enderror"
                                                    required>
                                                    <option value="">Pilih Ayah</option>
                                                    @foreach ($wargas as $warga)
                                                        <option value="{{ $warga->warga_id }}"
                                                            {{ old('ayah_warga_id', $kelahiran->ayah_warga_id) == $warga->warga_id ? 'selected' : '' }}>
                                                            {{ $warga->nama }} - {{ $warga->nik }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select name="ibu_warga_id"
                                                    class="form-control @error('ibu_warga_id') is-invalid @enderror"
                                                    required>
                                                    <option value="">Pilih Ibu</option>
                                                    @foreach ($wargas as $warga)
                                                        <option value="{{ $warga->warga_id }}"
                                                            {{ old('ibu_warga_id', $kelahiran->ibu_warga_id) == $warga->warga_id ? 'selected' : '' }}>
                                                            {{ $warga->nama }} - {{ $warga->nik }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @if ($kelahiran->tgl_lahir)
                                                            <div>
                                                                ...
                                                                <div>
                                                                    <strong>{{ \Carbon\Carbon::parse($kelahiran->tgl_lahir)->age }}
                                                                        tahun</strong>
                                                                </div>
                                                            </div>
                                                        @endif
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input class="form-check-input delete-checkbox"
                                                                            type="checkbox" name="delete_files[]"
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" name="files[]"
                                                ...
                                                accept=".jpg,.jpeg,.png,.pdf,.doc,.docx,.xls,.xlsx" id="filesInput"
                                                multiple onchange="previewNewFiles(this)">
                                            @error('files.*')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="text-muted">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.previewNewFiles = function(input) {
                ...
                Array.from(files).forEach((file, index) => {
                    ...
                    fileItem.className =
                        'list-group-item d-flex justify-content-between align-items-center border-success';
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (deleteCheckboxes.length === currentFileCount && newFileCount === 0) {
                    const confirmDelete = confirm(
                        'Anda akan menghapus semua dokumen dan tidak menambahkan yang baru. Lanjutkan?');
                    if (!confirmDelete) {
                        e.preventDefault();
                        return false;
                    }
